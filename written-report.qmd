...
$$
H_0: \beta_1,...,\beta_p = 0 \\ H_a: \beta_j \neq 0 \ for\ at\ least\ 1\ j
$$
...
Here is the calculated empirical logit plot for our only quantitative predictor variable and it appears to generally fit the linearity assumption. For the other qualitative predictor variables the emperical logic was calculated for the training dataset.
