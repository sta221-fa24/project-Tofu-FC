...
The bivariate exploratory data analysis also shows some interesting findings in particular, categories that have a disparity between the two different classes could offer potential modeling power in classification of the classes (toxicity). Cap shape of convex, bell, and others is more likely to be poisonous/toxic than edible. We also see that stem root of club and rooted tends to be poisonous, but there is relatively a low amount of observations. For stem color, yellow and brown tends to be more poisonous than not. And lastly the habitat of woods and the season of autumn and summer also observes a similar observation.
