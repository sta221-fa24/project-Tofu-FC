...
The data dictionary can be found [here](https://github.com/sta221-fa24/project-Tofu-FC/blob/main/data/README.md). There are 61069 total observations, each row represent a mushroom's physical features and also the environment it was found in.
