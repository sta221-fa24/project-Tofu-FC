...
Stem height and width, height or width in cm of the stem of the mushroom, both are quantitative variables of initial interest, but were removed as they were correlated to cap diameter (visualized with ggpairs).
...
Upon the univariate exploratory data analysis of some important predictors (did not include the other 2 quantitative variable and ring type because the former are collinear with cap diameter via VIFs analysis and the latter is less typically known by the common person), there shows some interesting results. With quantitative variable, cap diameter, the distribution appears to be skewed right and unimodal. For qualitative variables, there appears to be more common physical and environmental characteristics. For cap shape, flat and convex tends to be the most common, for stem root the most common was "missing data" (which likely suggests that this may be a variable to remove), for stem color is white, yellow, and brown, for habitat, woods is the most common, and lastly for season, autumn and summer tends to be the most common.
