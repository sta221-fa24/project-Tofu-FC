...
Mushrooms are vital to the general wellness of the ecosystem, decomposing and recycling the nutrients in the soil. Mushrooms also provides a valuable food source full of nutrients for human beings and other important organisms. However, some mushroom species can also be poisonous and harmful. With this in mind, we are interested to see whether there are any environmental factors and/or physical features of mushrooms that can help curious human avoid poisonous mushrooms that may grow in their yard. Ultimately, the study of mushrooms is essential for safety and well-being.
...
>
> (Brandenburg, William E, and Karlee J Ward. “Mushroom poisoning epidemiology in the United States.” Mycologia vol. 110,4 (2018): 637-641. doi:10.1080/00275514.2018.1479561).
